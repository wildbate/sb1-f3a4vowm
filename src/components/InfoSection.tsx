  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-8">
      ...
      <p className="text-gray-700 mb-6">
        ...
        the probability of schools in your area being cancelled over the next 14 days. Visit{' '}
        <a 
          href="https://www.weatherscientific.com" 
          target="_blank" 
        ...
        for more detailed weather analysis and forecasting tools.
      </p>
